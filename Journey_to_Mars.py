...
pygame.display.set_caption("Journey to Mars")
SURFACE = screen
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if keys[pygame.K_LEFT]:
                ...
                x += player_size / 2
                if x >= right_boundary:
                    x = right_boundary - player_size / 2
                ...
                y += player_size / 2
                if y >= bottom_boundary - player_size:
                    y = bottom_boundary - player_size
                current_image = player_images[pygame.K_DOWN]
            
            player_position = [x, y]

    # making the last position of the player disappear
